...
*Generated: 2026-06-11 08:51 | Price: $301.08 | Mkt Cap: $32B*
...
|--------|-------|--------|----------|-----------|----------------|
| Quality | 8.0/10 | 30% | 2.4 | ROE: 25.1% (financials — book-return proxy); Earnings: 3/3 up-years (monotonic); 5y price drawdown: 25% (stable); FCF/NI: n/a for financials (float/deposit accounting); Gross margin: n/a for financials | - |
...
| Valuation Fit | 6.0/10 | 20% | 1.2 | P/E 20.5x — growth premium; 52w range position: 53%; Owner earnings yield: 3.2%; Earnings yield < 7% — tight vs index | - |
...
- **Margin of Safety**: -3% — ABSENT ($301 > IV $293 at 25x for 25% growth)
