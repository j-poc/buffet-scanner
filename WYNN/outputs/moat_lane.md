...
|--------|-------|--------|----------|-----------|----------------|
| Quality | 0.5/10 | 30% | 0.1 | Avg ROIC: 6.4% (4y); Earnings: 2/3 down-years (unpredictable); NI drawdown: 55% from prior peak; 5y price drawdown: 47% (moderate cyclicality); FCF/NI: 153% (strong); Gross margin: 0% (below  norm) | - |
