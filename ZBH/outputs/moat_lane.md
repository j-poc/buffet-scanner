...
|--------|-------|--------|----------|-----------|----------------|
| Quality | 0.5/10 | 30% | 0.1 | Avg ROIC: 4.4% (4y); Earnings: 2/3 down-years (unpredictable); NI drawdown: 31% from prior peak; 5y price drawdown: 44% (moderate cyclicality); FCF/NI: 226% (strong); Gross margin: 0% (below  norm) | - |
