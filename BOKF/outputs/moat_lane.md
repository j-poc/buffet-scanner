...
*Generated: 2026-05-15 07:39 | Price: $127.31 | Mkt Cap: $8B*
...
|--------|-------|--------|----------|-----------|----------------|
| Quality | 5.1/10 | 30% | 1.5 | ROE: 10.4% (financials — book-return proxy); Earnings: 1 down-year in 3 transitions; 5y price drawdown: 0% (stable); FCF/NI: n/a for financials (float/deposit accounting); Gross margin: n/a for financials | - |
...
| Valuation Fit | 10.0/10 | 20% | 2.0 | P/E 12.0x — deep value; 52w range position: 74% | - |
...
- **Margin of Safety**: 94% — PRESENT (IV $247 vs $127 at 25x)
